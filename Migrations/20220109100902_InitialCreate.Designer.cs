...
namespace FullStackAPI.Migrations
{
    ...
    [Migration("20220109100902_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FullStackAPI.Inspection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FullStackAPI.InspectionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FullStackAPI.Status", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FullStackAPI.Inspection", b =>
                {
                    b.HasOne("FullStackAPI.InspectionType", "InspectionType")
                        .WithMany()
